    ...
    <header>
      <div class="profile-page sidebar-collapse">
        <nav class="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
          <div class="container">
            <div class="navbar-translate"><a class="navbar-brand" href="#" rel="tooltip">Portfolio</a>
...
<div class="profile-page">
  <div class="wrapper">
    <div class="page-header page-header-small" filter-color="green">
      <div class="page-header-image" data-parallax="true" style="background-image: url('images/wp1904056.webp')"></div>
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="#"><img src="images/anthony.jpg" alt="Image"/></a></div>
          <div class="h2 title">Abhishek Pratap Singh</div>
          <p class="category text-white">Software Developer (Backend Developer)</p><a class="btn btn-primary smooth-scroll mr-2" href="#contact" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Hire Me</a><a class="btn btn-primary" href="#" data-aos="zoom-in" data-aos-anchor="data-aos-anchor">Download CV</a>
        </div>
      </div>
      <div class="section">
        <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <p>Hello! I am Abhishek Pratap Singh. Software Developer</p>
            <p align=JUSTIFY>Enthusiastic software engineer with 3 Years of experience participating in the complete product development life cycle of successfully launched product NetHavoc. In previous roles, Worked in C, Shell Scripting, Batch Scripting on Linux Platform and also worked on GDB debugger tools, Makefile, Kubernetes, and Docker Container-Based Environment. And also worked on Core Dumps.
Also, reduced downtime by 15% and warranty costs by 25%; identified and resolved a process bottleneck that reduced coding efficiency by 2% to 30%.</p>
          </div>
        </div>
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">14-OCT-1996</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
              <div class="col-sm-8">abhishekssiin@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">+91 7011127266</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Work Location:</strong></div>
              <div class="col-sm-8">Gurgaon, Haryana, India</div>
            </div>
	    <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Home Location:</strong></div>
              <div class="col-sm-8">Hathras, UP, India</div>
            </div>
            <div class="row mt-3">
    ...
    <div class="card" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Shell Scripting</span>
              <div class="progress">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Data Structures and Algorithms</span>
              <div class="progress">
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">Docker Kubernetes</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div><span class="progress-value">60%</span>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">System Design</span>
              <div class="progress">
                <div class="progress-bar progress-bar-primary" data-aos="progress-full" data-aos-offset="10" data-aos-duration="2000" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 75%;"></div><span class="progress-value">75%</span>
              </div>
            </div>
          ...
          <div class="col-md-6">
            <div class="progress-container progress-primary"><span class="progress-badge">OOPS</span>
              <div class="progress">
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Xoriant Solutions Pvt. Ltd.</div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Amdocs Development Center India LLP</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Software Developer</div>
            <p>Ensemble is Amdocs platform that provides one of the leading summer core, billing and order management solutions for convergent telecom operation supports the full-range of feed-line and mobile serves ( including local, long distance, data, cable, wireless, Internet & Voip) </p>
<ul>
<li>Ensure the quality and performance of ensemble for Client Caro.</li>
<li>Worked on Architecture Changes for Specific as per Clients requirements.</li>
<li>Increase the Sequential Files System For billing.</li></ul>
<b>Skills:</b> C++ · Object-Oriented Programming (OOP) · C · Shell Scripting · Linux · MySQL · Docker Products · Unix · Kubernetes · GNU Debugger</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">Cavisson Systems</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Software Engineer</div>
            <p>
Ensured the quality and performance of NetHavoc
<br>Worked on the enhancement of Product in more environments
<ul> <li>Linux</li>
<li>Windows </li>
 <li>Docker</li>
<li>Kubernetes </li> </ul>
Worked on the feature enhancement in the Product
<ul><li>New Faults</li>
 <li>Scenarios</li></ul>
Worked on integration with other Product.
<br><b>Skills:</b> Object-Oriented Programming (OOP) · C · Shell Scripting · Linux · Docker Products · Unix · Batch Programming · Kubernetes · GNU Debugger</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-md-3 bg-primary" data-aos="fade-right" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body cc-experience-header">
            ...
            <div class="h5">National Informatics Centre, Govt. of India</div>
          </div>
        </div>
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Trainee</div>
            <p>The Online Cafeteria Management System is an online System in which Students can book their meals from the android application, and Admin can create and edit the food Menu.
<br><br/><b>Constraint:-</b>
<br/>● All users must register with the Android Application.
<br/>● Login information consists of Phone Numbers and passwords.
<br/>● Customers can view the menu and book it from there.
<br/>● Admin can view information, change information, upload Pictures related to Menu.
 
<br><br><b>Software Requirement Specification:- </b>
<br><b>1. Purpose:-</b> This SRS describes the software functional and non-functional requirements for the release of the online Cafeteria System. This document is intended to be used by the members of the project team that will implement and verify the correct functioning of the system. Unless otherwise noted, all requirements specified here are high priority and committed for release.
 
<br><b>2. Scope:-</b> The scope of this online study portal is to provide students to order meals from the campus cafeteria through an android application.
 
<br><b>3. Definitions, Acronyms, And The Abbreviations:-</b>
 Admin-Admin can upload Menu and is able to update or change any details related to Menu and is also able to send notification regarding the Order.
 Student-Student will search for their Meal and book it from the Android application.
 Database-Database is used to verify login and store the details of students, Menu and Request Id. Database used are Firebase and SQL lite.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container cc-education">
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5">Bachelors of Technology</div>
    ...
    <div class="card">
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            <div class="h5"></div>
            <p class="h5">Science Stream(PCM)</p>
	    <p class="category">St. Francis Inter College, CBSE</p>
            <p>Details Here</p>
          </div>
        </div>
      </div>
...
<div class="section" id="contact">
  <div class="cc-contact-information" style="background-image: url('images/staticmap.png')">
          ...
          <div class="col-md-9">
            <div class="card mb-0" data-aos="zoom-in">
              ...
              <div class="row">
                <!--<div class="col-md-6">
                  <div class="card-body">
                    <form action="https://formspree.io/abhishekssiin@gmail.com" method="POST">
                ...
                <div class="col-md-6">
                  <div class="card-body">
                    ...
                    <p class="pb-2">Gurugram, Haryana, India </p>
                    <p class="mb-0"><strong>Phone</strong></p>
                    <p class="pb-2">+9170-111-27266</p>
                    <p class="mb-0"><strong>Email</strong></p>
                    <p>abhishekssiin@gmail.com</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Abhishek Pratap Singh</div>
